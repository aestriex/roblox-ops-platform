module Hiring
  class QuestionsController < ApplicationController
    ...
    def show
      ...
      render partial: "hiring/questions/question", locals: { question: @question }
    end
    ...
    def create
      ...
      if @question.save
        ...
        respond_to do |format|
          format.turbo_stream
          format.html { redirect_to hiring_job_posting_path(@job_posting), notice: "Question added." }
        end
      else
    ...
    def update
      ...
      if @question.update(question_params)
        respond_to do |format|
          format.turbo_stream
          format.html { redirect_to hiring_job_posting_path(@job_posting), notice: "Question updated." }
        end
      else
    ...
    def destroy
      @question = @section.questions.find(params[:id])
      @question.destroy
      redirect_to hiring_job_posting_path(@job_posting), notice: "Question removed."
    end
